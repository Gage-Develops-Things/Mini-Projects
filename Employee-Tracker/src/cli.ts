 ...
 addDepartment(): void {
    inquirer
        ...
        .then((answers) => {
            ...
            pool.query(sql, parameters, (err: Error, result: QueryResult) => {
                if (err){
                    console.log(err);
                    } else if (result) {
    ...
    inquirer
        .prompt([
            ...
            },
            {
                ...
                name: 'roleId',
                message:
                  'Enter role id for role.',
            },
            {
                type: 'input',
                name: 'managerId',
                message:
                  'Enter manager id for employee, if applicable.',
            },
          ])
        .then((answers) => {
        ...
        .prompt([
            {
                ...
                name: 'employeeId',
                message:
                  'Enter id for employee you would like to change.',
            },
            {
                type: 'input',
                name: 'roleId',
                message:
                  'Enter new role id for employee.',
            },
        ])
        .then((answers) => {
