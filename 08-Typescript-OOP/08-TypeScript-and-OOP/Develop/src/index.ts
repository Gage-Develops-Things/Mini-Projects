...
const starterAnimalData: Array<Animal> = []
// TODO: Create an array that will take in the Employee Objects
const starterEmployeeData: Array<Employee> = []

// Add the existing animals and employees
// TODO: The following default objects will not be created. Update the related classes to make the objects generate (DONE i think)
